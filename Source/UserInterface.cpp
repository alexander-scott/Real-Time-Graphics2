...
bool UserInterface::Initialize(DX11Instance* Direct3D, int screenHeight, int screenWidth)
{
	bool result;
	char videoCard[128];
	int videoMemory;
	...
	result = m_Font1->Initialize(Direct3D->GetDevice(), Direct3D->GetDeviceContext(), "Source/Fonts/font01.txt", 
								 "Source/Fonts/font01.tga", 32.0f, 3);
	if (!result)
	{
		return false;
	}
...
bool UserInterface::Render(DX11Instance* Direct3D, ShaderManager* ShaderManager, XMMATRIX worldMatrix, XMMATRIX viewMatrix, 
