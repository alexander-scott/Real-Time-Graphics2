...
SceneTerrainGeneration::SceneTerrainGeneration() : IScene()
{
}
...
void SceneTerrainGeneration::Destroy()
{
...
bool SceneTerrainGeneration::Update(DX11Instance* direct3D, Input* input, ShaderManager* shaderManager, float frameTime)
{
...
void SceneTerrainGeneration::ProcessInput(Input* Input, float frameTime)
{
	bool keyDown;
...
bool SceneTerrainGeneration::Draw(DX11Instance* direct3D, ShaderManager* shaderManager, TextureManager* textureManager)
{
